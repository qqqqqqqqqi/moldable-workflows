...
class LPCkptCrossover(Strategy):
    ...
    def allocation(self):
        ...
        with open("runtime.csv", "a", newline='') as f:
            writer = csv.writer(f)
            writer.writerow(["ckptCrossover", self.w, self.P, stats["lp_write_end"] - stats["lp_write_start"]])
    ...
    # BASELINE only checkpointnew tasks with crossover dependencies
    def checkpoint(self):
        tmpCkpt = []
